(function ($, window, document, undefined) {
    ...
    BootstrapDualListbox.prototype = {
        init: function () {
            this.container = $("" + '<div class="bootstrap-duallistbox-container">' + ' <div class="box1">' + "   <label></label>" + '   <span class="info-container">' + '     <span class="info"></span>' + '     <button type="button" class="btn clear1 pull-right"></button>' + "   </span>" + '   <input class="filter form-control ue-form" style="width: 42%;" type="text">' + '   <select multiple="multiple" style="margin-top: 4px;width: 98%"></select>' + " </div>" + ' <div class="btn-box">' + '     <button type="button" class="btn db-btn move">' + "       <i></i>" + "     </button>" + '     <button type="button" class="btn db-btn moveall">' + "       <i></i>" + "       <i></i>" + "     </button>" + '     <p class="clearfix" style="margin-bottom:20px"></p>' + '     <button type="button" class="btn db-btn remove">' + "       <i></i>" + "     </button>" + '     <button type="button" class="btn db-btn removeall">' + "       <i></i>" + "       <i></i>" + "     </button>" + " </div>" +
                ' <div class="box2">' + "   <label></label>" + '   <span class="info-container">' + '     <span class="info"></span>' + '     <button type="button" class="btn clear2 pull-right"></button>' + "   </span>" + '   <input class="filter form-control ue-form" style="width: 42%;"  type="text">' + '   <select multiple="multiple" style="margin-top: 4px;width: 98%"></select>' + " </div>" + ' <div class="settingUp-btns">' + '    <button class="btn db-btn upBtn">' + "      <i></i>" + "    </button>" + '    <button class="btn db-btn downBtn">' + "      <i></i>" + "    </button>" + " </div>" + "</div>").insertBefore(this.element);
            this.elements = {
            ...
            if (options.nonSelectedList != null) {
                for (var i in options.nonSelectedList) {
                    if (options.nonSelectedList.hasOwnProperty(i)) {
                        ...
                        items += "<option data-options='"+JSON.stringify(options.nonSelectedList[i][options.optionData])+"' value='" + options.nonSelectedList[i][options.optionValue] + "'>" + options.nonSelectedList[i][options.optionText] + "</option>"
                    }
                }
            }
            if (options.selectedList != null) {
                for (var i in options.selectedList) {
                    if (options.selectedList.hasOwnProperty(i)) {
                        items += "<option data-options='"+JSON.stringify(options.selectedList[i][options.optionData])+"' value='" + options.selectedList[i][options.optionValue] + "' selected>" + options.selectedList[i][options.optionText] + "</option>"
                    }
                }
            }
            box.append(items);
