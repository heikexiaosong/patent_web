...
@Controller
@RequestMapping("patent/trademark")
public class TrademarkController extends BaseController {
    ...
    public String index() {
        if (UserInfoUtil.isRole("admin")){
            return "patent/trademark/admin";
        }

        return "patent/trademark/index";
    }

    @RequestMapping("/add")
    public String add() {
        return "patent/trademark/edit";
    }
    ...
    public String importpage() {
        return "patent/trademark/importpage";
    }
